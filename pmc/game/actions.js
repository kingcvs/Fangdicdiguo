...
const GameActions = {
    ...
    confirmStartProject: function(landId, projectName, projectType, managerId) {
        ...
        const project = {
            ...
            quality: 50,
            certificates: [
                { type: GameTypes.CertificateTypes.LAND, status: GameTypes.CertificateStatus.PENDING, progress: 0 },
                { type: GameTypes.CertificateTypes.PLANNING, status: GameTypes.CertificateStatus.PENDING, progress: 0 },
                { type: GameTypes.CertificateTypes.CONSTRUCTION, status: GameTypes.CertificateStatus.PENDING, progress: 0 },
                { type: GameTypes.CertificateTypes.PRESALE, status: GameTypes.CertificateStatus.PENDING, progress: 0 }
            ]
        };
        
        // 开始办理第一个证书
        project.certificates[0].status = GameTypes.CertificateStatus.PROCESSING;
